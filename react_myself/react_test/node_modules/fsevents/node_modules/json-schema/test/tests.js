...
var schemaNames = ['schema', 'hyper-schema', 'links', 'people.json-ref' ];
var schemas = {};
...
var suite = vows.describe('JSON Schema').addBatch({
    ...
    'Json-Ref self-validates': assertSelfValidates('people.json-ref'),
    'Json-Ref/Hyper': assertValidates('people.json-ref', 'hyper-schema'),
    'Json-Ref/Core': assertValidates('people.json-ref', 'schema')
}).export(module);
