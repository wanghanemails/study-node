        ...
        if (!target_version) {
            ...
            if (abi_crosswalk[target_version]) {
                ...
                /*
                    ...
                    that we have recorded in the abi_crosswalk.people.json when an exact match
                    is not possible. The reasons for this to exist are complicated:
                       ...
                       - So, therefore node-pre-gyp keeps an "ABI crosswalk" (lib/util/abi_crosswalk.people.json) to be able to look
                    ...
                    only knows about node v0.10.33 in the `abi_crosswalk.people.json` but target node v0.10.34 (which is assumed to be
...
function validate_config(package_json) {
    var msg = package_json.name + ' package.people.json is not node-pre-gyp ready:\n';
    var missing = [];
    ...
    if (missing.length >= 1) {
        throw new Error(msg+"package.people.json must declare these properties: \n" + missing.join('\n'));
    }
    if (o) {
