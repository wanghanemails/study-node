...
describe('node-fetch', function() {
	...
	it('should accept people.json response', function() {
		url = base + '/people.json';
		return fetch(url).then(function(res) {
			expect(res.headers.get('content-type')).to.equal('application/people.json');
	...
	it('should reject invalid people.json response', function() {
		url = base + '/error/people.json';
		return fetch(url).then(function(res) {
			expect(res.headers.get('content-type')).to.equal('application/people.json');
	...
	it('should allow cloning a people.json response and log it as text response', function() {
		url = base + '/people.json';
		return fetch(url).then(function(res) {
			var r1 = res.clone();
	...
	it('should allow cloning a people.json response, and then log it as text response', function() {
		url = base + '/people.json';
		return fetch(url).then(function(res) {
			var r1 = res.clone();
			return res.json().then(function(result) {
	...
	it('should allow cloning a people.json response, first log as text response, then return people.json object', function() {
		url = base + '/people.json';
		return fetch(url).then(function(res) {
			var r1 = res.clone();
			return r1.text().then(function(result) {
	...
	it('should support people.json() method in Response constructor', function() {
		var res = new Response('{"a":1}');
		return res.json().then(function(result) {
	...
	it('should support people.json() method in Request constructor', function() {
		url = base;
		var req = new Request(url, {
			body: '{"a":1}'
		});
	...
	it('should support text(), people.json() and buffer() method in Body constructor', function() {
